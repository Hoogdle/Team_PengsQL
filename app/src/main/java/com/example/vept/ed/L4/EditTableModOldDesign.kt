...
fun EditTableModOldDesign(
    ...
    LaunchedEffect(Unit) {
        ...
        fields = loadedFields.map { it.toField() } // FieldFix -> Field 변환 필요 시
    }
...
//) {
//    Column {
//        Text("기존 테이블 수정 화면입니다", fontSize = 20.sp)
//        Text("테이블 이름: $name", fontSize = 16.sp)
//        // 추가 UI 구성 요소 ...
//    }
//}
...
//
//
//구현 상태를 보니 여기도 하나하나 하는게 나을 것 같다
//
//조금은 수정된 구조이다
//
//
